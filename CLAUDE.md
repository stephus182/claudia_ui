...
content of the modify order endpoint will follow the same structure as the standard
/iserver/account/{accountId}/orders endpoint. The content should mirror the content of the
original order."* Source: https://www.interactivebrokers.com/campus/ibkr-api-page/cpapi-v1/#modify-order
