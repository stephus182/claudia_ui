...
Four items carried forward from 2026-07-28. Ordered by what actually bites first, not by
where they sit in the gap table.

0. **🔴🔴 A completed staging is invisible to the model (gap #2) — the top open defect.**
